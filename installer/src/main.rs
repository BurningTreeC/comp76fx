//! Installs the Comp76Fx plugin bundles that sit next to this program.
//!
...
const BUNDLES: [(&str, &str); 6] = [
    ("Comp76Fx Rev A.clap", "CLAP"),
    ("Comp76Fx Rev A.vst3", "VST3"),
    ("Comp76Fx Rev D.clap", "CLAP"),
    ("Comp76Fx Rev D.vst3", "VST3"),
    ("Comp76Fx Rev F.clap", "CLAP"),
    ("Comp76Fx Rev F.vst3", "VST3"),
];
...
fn writable(dir: &Path) -> bool {
    ...
    let probe = dir.join(".comp76fx-write-test");
