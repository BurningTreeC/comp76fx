#!/usr/bin/env python3
"""Regenerate THIRD-PARTY-NOTICES.md from the crates Comp76Fx actually links.
...
def linked_packages(meta):
    ...
    # Three plugins share a core, so every one of them is a starting point.
    roots = [
        p["id"]
        for p in meta["packages"]
        if p["name"].startswith("comp76fx")
    ]
...
def main():
    ...
    out = [
        "# Third party notices",
        "",
        "The Comp76Fx plugins are distributed under the GNU General Public",
