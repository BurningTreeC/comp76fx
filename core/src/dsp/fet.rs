...
/// so the channel modulates a good deal further for the same gain reduction.
/// This is what makes the setting dirty rather than merely slow.
const ALL_BUTTON_SHIFT: f64 = 3.2;
