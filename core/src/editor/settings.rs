...
/// a list that runs past the bottom edge is simply cut off rather than
/// overhanging. With nine scales it does run past, which used to put 200%
/// out of reach. So it slides up far enough to fit and overlaps the rows
/// above instead, which is what a menu is entitled to do.
fn menu_top() -> f32 {
