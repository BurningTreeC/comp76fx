...
| --- | --- | --- | --- |
| comp76fx_rev_a | Comp76Fx Rev A | `com.burningtreec.comp76fx.rev-a` | `C76A` |
| comp76fx_rev_d | Comp76Fx Rev D | `com.burningtreec.comp76fx.rev-d` | `C76D` |
| comp76fx_rev_f | Comp76Fx Rev F | `com.burningtreec.comp76fx.rev-f` | `C76F` |
...
cargo xtask bundle-au comp76fx_rev_a --release
...
dist/macos/
  ...
  comp76fx_rev_a/
    Comp76Fx Rev A.clap
    Comp76Fx Rev A.vst3
    Comp76Fx Rev A.component
    auv3/
      Comp76Fx Rev A AUv3.app/
        Contents/PlugIns/Comp76Fx Rev A.appex/
          Contents/PlugIns/Comp76Fx Rev A.clap/
```
...
```bash
python3 packaging/macos/au.py sign "dist/macos/comp76fx_rev_a/Comp76Fx Rev A.component"
python3 packaging/macos/au.py sign "dist/macos/comp76fx_rev_a/auv3/Comp76Fx Rev A AUv3.app"
codesign --verify --deep --strict --verbose=4 "dist/macos/comp76fx_rev_a/Comp76Fx Rev A.component"
codesign -dv --verbose=4 "dist/macos/comp76fx_rev_a/auv3/Comp76Fx Rev A AUv3.app"
```
...
```bash
app="$HOME/Applications/Comp76Fx Rev A AUv3.app"
/System/Library/Frameworks/CoreServices.framework/Frameworks/LaunchServices.framework/Support/lsregister -f "$app"
pluginkit -a "$app/Contents/PlugIns/Comp76Fx Rev A.appex"
pluginkit -m -v -i com.burningtreec.comp76fx.rev-a.auv3.extension
open "$app"
```
...
lipo -archs "dist/macos/comp76fx_rev_a/Comp76Fx Rev A.component/Contents/MacOS/Comp76Fx Rev A"
file "dist/macos/comp76fx_rev_a/Comp76Fx Rev A.component/Contents/PlugIns/Comp76Fx Rev A.clap/Contents/MacOS/Comp76Fx Rev A"
```
...
- Existing `cargo test --release --offline`: 23 passed, 0 failed,
...
Investigated [the failed run](https://github.com/BurningTreeC/comp76fx/actions/runs/34839512611)
